...
def para():
    ...
    parser.add_argument('--dataset_name', type=str, default="arxiv", help=
    'cora, citeseer, pubmed, arxiv, flickr, reddit, products')
    parser.add_argument('--ratio', type=float, default= 0.0005)  # todo 压缩比例
    ...
    parser.add_argument('--lr_feat', type=float, default=0.001, help='特征矩阵学习率')
    parser.add_argument('--alpha1', type=float, default=0.5, help='mlp loss')
    parser.add_argument('--deta', type=float, default=0.5,help='class loss')
    parser.add_argument('--condensation_epoch', type=int, default=200)
    parser.add_argument('--anchor',type=int,default=3)

    parser.add_argument('--mlp_epoch', type=int, default=200)
    parser.add_argument('--lr_mlp', type=float, default=0.005, help='mlp学习率')
